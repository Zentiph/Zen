...
/// A representation of the parser's state.
...
/// @return parser_t - The initialized parser.
///
...
/// @return true      - If the current token's type and expected type match.
/// @return false     - If the current token's type and expected type do not
/// match.
///
bool parser_match(parser_t parser, Token token_type);

///
/// @brief Determine if the current token matches given token type without
///        advancing.
///
/// @param parser     - The parser.
...
///
/// @brief Similar to parser_match(), but with an error message on failure
///        instead.
///
/// @param parser   - The parser.
/// @param token_type - The token type to check.
...
///
/// @param parser      - The parser.
/// @return ast_node_t - The AST node representing the expression.
///
...
///
/// @param parser      - The parser.
/// @return ast_node_t - The AST node representing the statement.
///
...
///
/// @param parser      - The parser.
/// @return ast_node_t - The AST node representing the code block.
///
...
///
/// @param parser      - The parser.
/// @return ast_node_t - The AST node representing the if statement.
///
...
///
/// @param parser      - The parser.
/// @return ast_node_t - The AST node representing the while statement.
///
...
///
/// @param parser      - The parser.
/// @return ast_node_t - The AST node representing the function definition.
///
...
///
/// @param parser      - The parser.
/// @return ast_node_t - The AST node representing the function call.
///
