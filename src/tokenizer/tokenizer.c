...
Token next_token(FILE *fp)
{
    ...
    if (isalpha(ch) || ch == '_')
    {
        ...
        if ((token.value[0] == 'a' && token.value[1] == 'n' && token.value[2] == 'd' && token.value[3] == '\0') || (token.value[0] == 'o' && token.value[1] == 'r' && token.value[2] == '\0') || (token.value[0] == 'n' && token.value[1] == 'o' && token.value[2] == 't' && token.value[3] == '\0'))
        {
