...
// gcc tests/parser/tokenizer/test_tokenizer.c src/parser/tokenizer/tokenizer.c src/parser/tokenizer/tokenizer_base.c src/parser/tokenizer/token_repr.c tests/parser/zassert.c -o tests/parser/tokenizer/test_tokenizer
...
#include "../zassert.h"
#include "../../../src/parser/tokenizer/tokenizer_base.h"
